...
export function DartboardSvg({
  ...
  const wedgeComponents = numbers.map((number, index) => {
    ...
    return (
      <g id={`${number}-wedge`} key={number} transform={`rotate(${angle})`}>
        <use
          id={`${number}-double`}
          href="#double"
          height="500"
          ...
          y="0"
          x="0"
          fill={wedgeSectionColor(number, index, "double")}
          onClick={wedgeSectionClickHandler(number, "double")}
        />
        <use
          id={`${number}-outer`}
          href="#outer"
          ...
          y="0"
          x="0"
          fill={wedgeSectionColor(number, index, "outer")}
          onClick={wedgeSectionClickHandler(number, "outer")}
        />
        <use
          id={`${number}-treble`}
          href="#triple"
          ...
          y="0"
          x="0"
          fill={wedgeSectionColor(number, index, "triple")}
          onClick={wedgeSectionClickHandler(number, "triple")}
        />
        <use
          id={`${number}-inner`}
          href="#inner"
          ...
          y="0"
          x="0"
          fill={wedgeSectionColor(number, index, "inner")}
          onClick={wedgeSectionClickHandler(number, "inner")}
        />
      </g>
    );
  });
  return (
    <svg id="svg2" width={500} viewBox="-250 -250 500 500" version="1.0">
      ...
      <g
        ...
        pointerEvents="none"
        fill="#c0c0c0"
        transform="translate(26.452 47.674)"
      >
        <path
          id="text277"
        ...
        <path
          id="text303"
          d="m-162.66 124.2l12.56 9.13-0.82 1.13-20.47 13.25-2.76-2 19.25-12.47-9.38-6.81 1.62-2.23"
        />
        <path
          id="text305"
